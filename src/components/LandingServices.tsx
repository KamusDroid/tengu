...
export default function LandingServices() {
  return (
    <section className="mx-auto max-w-6xl px-4 py-20">
      <h2 className="mb-12 text-3xl font-bold text-center">Accedé rápido a todo lo nuevo de Tengu</h2>
      ...
      <div className="grid gap-8 md:grid-cols-3 text-center">
          {cards.map((c) => (
            <div key={c.title} className="vortex-hover block rounded-xl border border-[#796363] bg-[#615353] p-6 transition-transform hover:scale-105 hover:shadow-lg">
              ...
              <p className="mt-1 text-md font-semibold text-gray-400">{c.desc}</p>
              <Link
                href={c.href}
      ...
      <p className="mt-6 text-xs opacity-90">
        * Para comprar, necesitás iniciar sesión. Los pagos se procesan de forma segura.
      </p>
    </section>
  )
}
